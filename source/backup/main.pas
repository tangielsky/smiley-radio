...
begin
  ...
  //Radio erst später einschalten, nicht zum Entwickeln
  //CurrentRadioItem:=TItemPanel(IplRadio.Data[1]);
  //PlayRadio;
...
begin
  ...
  //messagedlg('Play:'+CurrentRadioItem.Url,mtinformation,mbyesnocancel,0);
